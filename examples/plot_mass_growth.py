...
# Find all galaxies that merge with the target by z = 0
...
# Sum the progenitor masses in each snapshot
...
m_star_tot = np.sum(10.0**m_star_progenitors, axis=0)

# Plot it on top of the galaxy's own mass evolution
plt.axes(ax)
...
ax2.set_ylabel(r'Stellar metallicity ($Z$)')
